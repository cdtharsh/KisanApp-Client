...
const String kAgri = "Agri Products";
...
const String kComminuty = "Community";
const String kDashboardSearch = "Search";
const String kDontHaveAccount = "Don't have Account?";
const String kDrip = "Drip Accessories";
const String kEmail = "* Email";
const String kEmailVerificationSubTitle =
    'We have sent you a verification link on the provided mail address. Please open the email and click on the link, then come back to the app.';
...
const String kFirstName = "* First Name"; // Added here
const String kLastName = "* Last Name"; // Added here
...
const String kMandatory = "* Shows mandatory fields!";
...
const String kPostalCode = "* Post Code"; // Added here
...
const String kSomething = "Oops, Something went wrong!";
